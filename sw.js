const CACHE='vigo-v19-ballast-startwaarden';const A=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.hostname.includes('pegelonline.wsv.de')||u.hostname.includes('rijkswaterstaat.nl')){e.respondWith(fetch(e.request,{cache:'no-store'}));return}
